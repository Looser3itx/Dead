...
section:Button("GPU/CPU Saver", function()
    _G.ShowUp = true --// Shows the gui above (Useful for games like TPT2)

loadstring(game:HttpGet("https://raw.githubusercontent.com/Just3itx/C9Z-Hub/main/sus.lua"))()
end)
...
local tab = window:Tab("C9Z Inf Yeild Verison")
local section = tab:Section("Inf Yeild But C9Z Verison")
local title = section:Title("Click on Excute")
section:Button("Execute", function()
...
PluginsHint.Text = "Download plugins from the IY Discord (discord.gg/c9z)"
...
task.spawn(function()
	if pcall(function() loadstring(game:HttpGet('https://raw.githubusercontent.com/Just3itx/C9Z-Hub/main/verison'))() end) then
		if ver ~= Version then
			notify('Wow','your cringe for chaing the verison! Senting to discord webhook')
		end
		if Announcement and Announcement ~= '' then
			...
			PopupText.Font = Enum.Font.SourceSans
			PopupText.TextSize = 14
			PopupText.Text = "Important Message"
			PopupText.TextColor3 = currentText1
			PopupText.TextWrapped = true
